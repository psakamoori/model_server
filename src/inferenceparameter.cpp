...
//
static size_t DataTypeToByteSize(OVMSDataType datatype) {
    switch (datatype) {
...
InferenceParameter::InferenceParameter(const char* name, OVMSDataType datatype, const void* data) :
    name(name),
    datatype(datatype),
...
OVMSDataType InferenceParameter::getDataType() const {
