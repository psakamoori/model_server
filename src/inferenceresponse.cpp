...
Status InferenceResponse::addOutput(const std::string& name, OVMSDataType datatype, const size_t* shape, size_t dimCount) {
...
Status InferenceResponse::addParameter(const char* parameterName, OVMSDataType datatype, const void* data) {
